...
| _(not applicable)_             | `modules/vpc/README.md`                      | NEW — Documentation for the reusable VPC module                                   |
| _(not applicable)_             | `c3-vpc.tf` (root)                           | NEW — Instantiates `module "vpc"` and passes inputs                               |
